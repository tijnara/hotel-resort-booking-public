...
export function AdminDashboardComponent({
    ...
    // Supabase Realtime Listener for Instant Front Desk Updates
    useEffect(() => {
        ...
        const channel = supabase
            ...
            .on(
                ...
                () => {
                    // Instantly re-fetch server data on new booking, status update, or deletion
                    router.refresh();
                }
            )
            .subscribe();
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-2">
                ...
                <div className="flex items-center justify-between gap-3 border-b border-[#e6c898]/40 pb-4 flex-wrap">
                    ...
                    {/* Live WebSocket Realtime Indicator Badge */}
            ...
            {mainTab === 'bookings' ? (
                ...
                /* TAB 5: Staff Directory & Management */
