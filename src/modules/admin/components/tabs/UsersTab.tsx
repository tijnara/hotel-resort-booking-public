...
import { Loader2, ShieldAlert, Edit3, Trash2 } from 'lucide-react';
...
interface UsersTabProps {
    ...
    onCreateUser: (payload: { fullName: string; email: string; password: string; role: string }) => Promise<{ success: boolean; message?: string }>;
...
export function UsersTab({
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        const res = await onCreateUser({ fullName, email, password, role });
