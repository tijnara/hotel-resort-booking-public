...
export function SiteSettingsForm({ settings }: SiteSettingsFormProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl relative">
            ...
            {/* Sticky Sub-Tabs Navigation Bar */}
            <div className="sticky top-0 z-30 flex items-center gap-2 p-1.5 bg-[#faf7f2]/90 backdrop-blur-md rounded-2xl border border-[#e6c898]/40 shadow-xs overflow-x-auto [scrollbar-width:none]">
                <button
                    type="button"
                ...
                >
                    <Palette className="w-3.5 h-3.5 text-[#c89349]" />
                ...
                >
                    <Camera className="w-3.5 h-3.5 text-[#c89349]" />
                ...
                >
                    <Phone className="w-3.5 h-3.5 text-[#c89349]" />
                ...
                >
                    <MapPin className="w-3.5 h-3.5 text-[#c89349]" />
                    <span>Footer Info</span>
                </button>
            </div>

            {/* TAB 1: BRANDING & NAVIGATION LINKS */}
            {subTab === 'branding' && (
